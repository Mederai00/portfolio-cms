 ...
 */
final class Version20210422143124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE block ADD type VARCHAR(255) NOT NULL, DROP type_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE block ADD type_id INT NOT NULL, DROP type');
    }
}
